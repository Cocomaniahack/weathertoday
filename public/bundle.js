...
function getCurrent(dataGeolocation, done) {
  ...
  $.getJSON(API_WEATHER_URL + "lat=" + lat + "&lon=" + lon, function getCurrentWeather(response) {
    ...
    jQuery('#main-weather').html('<row>' + '<div class="col-xs-11 col-sm-11 col-md-11"><h2 style="padding-left: 15px;">' + response.sys.country + '. ' + response.name + ' </h2></div>' + '</row>' + '<div class="col-xs-1 col-sm-1 col-md-1" style="margin-top: 15px"><i class="fa fa-2x fa-refresh update-co" aria-hidden="true"></i></div>' + '<div id="' + response.id + '">' + template(response) + '</div>');
...
},{"./autocomplete":2,"./autocomplete/select.js":3,"./config":5,"./footer":6,"./public/button.js":29,"./storage.js":30,"./template":31,"./weather.js":34,"jquery":27}],2:[function(require,module,exports){
"use strict";

var select = require('./select.js');

module.exports = function completar() {

  $(".autoc").on("keydown", function (event) {
    if (event.keyCode == 38) {
      res();
      ...
      var chart = jQuery("input:first").val();
      var dato = chart.slice(0, -1);
      select(dato);
    }
  });
  ...
  function sum() {
    ...
    if (n == null) {
      n = 0;
      number1 = 0;
      $("div .respon").last().removeClass('grys');
    } else {}

    div.prev().removeClass('grys');
    div.addClass('grys');
    var name = div.text();
    $('.autoc').val(name);
  }
  ...
  function res() {
    ...
    if (number1 < 0) {
      var lastD = $("div .respon").last().attr('id');
      $("div .respon").first().removeClass('grys');
      n = parseInt(lastD) + 1;
    }

    var div = $('#' + number1);
    div.next().removeClass('grys');
    div.addClass('grys');
    var name = div.text();
    $('.autoc').val(name);
  }
...
},{"./select.js":3}],3:[function(require,module,exports){
'use strict';

module.exports = function select(dato) {

  if (dato.length <= 2) {

    $('#suggesstion-box').addClass('hide');
  } else {
    $('#suggesstion-box').removeClass('hide');
  ...
  function autocomplet(data) {
    ...
    var res = Arry.map(function (pic) {

      var id = suma++;
      return "<div class='respon' id='" + id + "'>" + pic + "</div>";
    });

    templateSearch(res);
  };

  function templateSearch(res) {
...
el.innerHTML = '<footer class="bd-footer text-muted">' + '<div class="container">' + '<ul class="bd-footer-links">' + '<li><a style="margin-right: 8px" href="https://github.com/JulianDa/weathertoday">GitHub</a></li>' + '<li><a style="margin-right: 8px" href="">Facebook</a></li>' + '<li><a style="margin-right: 8px" href="/examples/">Examples</a></li>' + '<li><a style="margin-right: 8px" href="/about/history/">About</a></li>' + '</ul>' + '<p>Designed and built with all the love in the world by <a href="juliansytem@gmail.com" target="_blank">juliansytem@gmail.com</a>. with the help of <a href="https://github.com/twbs/bootstrap/graphs/contributors">our contributors</a>.</p>' + '<p>Currently v4.0.0-alpha.6. Code licensed <a rel="license" href="https://github.com/twbs/bootstrap/blob/master/LICENSE" target="_blank">MIT</a>, © 2017 Framework <a rel="license" href="https://creativecommons.org/licenses/by/3.0/" target="_blank">CC BY 3.0</a>.</p>' + '</div>' + '</footer>';
...
},{"./lib/locales":7,"./lib/main":15}],11:[function(require,module,exports){
/*
...
},{"./lib/locales":7,"./lib/main":22}],18:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./diff":19,"./es5":21,"intl-messageformat":10}],19:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./core":18,"./en":20,"dup":15}],23:[function(require,module,exports){
(function (global){
...
},{"./lib/core.js":24,"./locale-data/complete.js":7}],24:[function(require,module,exports){
(function (global){
'use strict';
...
module.exports = {
  ...
  update: function update(id) {
    ...
    $('.update-co').on('click', function () {
      ...
      var tipo = '2';
      _update(id, null, tipo);
    });
  }

};

},{"../template":31,"../update":33}],30:[function(require,module,exports){
'use strict';
...
},{"./template":31,"./weather.js":34}],31:[function(require,module,exports){
'use strict';
...
module.exports = function (data) {
  ...
  function render(data) {
    ...
    var template = '<row>' + '<div class="col-xs-12 col-sm-12 col-md-12"> <h3 style="margin-left: 15px; margin-bottom: 0px; margin-top: 0px;">' + data.weather[0].description + '</h3></div> ' + '</row>' + '<div class="container-fluid" style="padding-left: 0px;">' + '<row>' + '<div class="col-md-1 col-xs-3" style="padding-right: 0px; text-align: center"><i class="fa fa-' + icons(iconID) + ' fa-3x" style="margin-top: 9px;" aria-hidden="true"></i></div>' + '<div class="col-md-1 col-xs-2" style="padding-right: 0px; padding-left: 0px; display: table; text-align: center"><h1 style="margin: 0px;" class="centígrados" id="centígrados">' + cent(data.main.temp) + '</h1><h1  class="hide Fahrenheit"  style="margin: 0px;" id="Fahrenheit">' + Fahrenheit + '</h1></div>' + '<div class="col-md-2 col-xs-4 ChangeTemp" style="padding-left: 8px;"><h4><a class="Celci point" style="color: whitesmoke;cursor: pointer;">ºC</a> | <a class="fare" style="color: whitesmoke;cursor: pointer;">ºF</a></h4></div>' + '<div class="tempsC">' + '<div class="col-md-9 col-xs-1 max-tC">Max ' + cent(data.main.temp_max) + '</div>' + '<div class="col-md-9 col-xs-1 min-tC">Min ' + cent(data.main.temp_min) + '</div>' + '</div>' + '<div class="tempsF hide">' + '<div class="col-md-9 col-xs-1 max-tF">Max ' + farent(data.main.temp_max) + '</div>' + '<div class="col-md-9 col-xs-1 min-tF">Min ' + farent(data.main.temp_min) + '</div>' + '</div>' + '</row>' + '</div>' + '<p style="color: whitesmoke; margin-left: 33px">Humidity ' + humedad + ' %</p>' + '<p style="color: whitesmoke; margin-left: 33px" class="time">Now</p>';
...
},{"./translate":32}],32:[function(require,module,exports){
'use strict';
...
},{"intl":23,"intl-relativeformat":17,"intl/locale-data/jsonp/en-US.js":25,"intl/locale-data/jsonp/es.js":26}],33:[function(require,module,exports){
"use strict";
...
},{"./changeTe.js":4,"./config":5,"./template":31}],34:[function(require,module,exports){
"use strict";
...
},{"./config":5,"./public/button.js":29,"./template":31}]},{},[1]);
